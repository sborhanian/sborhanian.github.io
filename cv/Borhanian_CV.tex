...
\begin{center}
  ...
  {\small\color{muted}
    ...
    ~|~
    \faLinkedin~\href{https://www.linkedin.com/in/ssohrab-borhanian}{ssohrab-borhanian}
    ~|~
    \faGitlab~\href{https://gitlab.com/sborhanian}
    {sborhanian}
  }
\end{center}
...
\begin{itemize}
  ...
  \item Documented, packaged, and maintained for long-term community use; peer-reviewed publication.
\end{itemize}
...
\cventry%
  ...
  {09/2023 -- Present}
\begin{itemize}
  \item Developing ML-based and non-parametric, hierarchical gravitational-wave data analysis pipelines.
...
\cventry%
  ...
  {06/2021 -- 08/2023}
\begin{itemize}
  \item Contributed to and extended the functionality of the open-source Python packages \textsc{xkn} and \textsc{gwbench}.
...
\cvskill{Programming}{Python, Swift, SwiftUI, Fortran, Java.}
\cvskill{Python Ecosystem}{JAX, NumPy, SciPy, Pandas, Matplotlib, h5py, joblib, multiprocessing, setuptools.}
\cvskill{Developer Tools}{Git, Linux, HPC clusters (SLURM/HTCondor), Mathematica, MATLAB, \LaTeX{}.}
